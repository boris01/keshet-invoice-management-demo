---
description: Concise critical rules for Angular 21+ and NestJS development. Full code examples in the skills directories.
---

# Project Rules

> Only the rules that **break the app** if violated. For detailed examples, see the `.claude/skills/` directory.
...
For full code examples and patterns on all topics above (plus caching, i18n, responsive design, security, interceptors, pipes, API versioning), see the `.claude/skills/` directory.
